package com.alihmzyv.producer.delivery.timeout.ms;
...
public class DeliveryTimeoutMsReached {
    ...
    static {
        ...
        kafkaProps.put("request.timeout.ms", 5_000);
        kafkaProps.put("delivery.timeout.ms", 15_000);
